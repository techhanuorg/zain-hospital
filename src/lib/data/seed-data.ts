...
export const SEED_HOSPITAL: Hospital = {
  hospital_id: 'hosp_apex_01',
  name: 'Apex Super Speciality & Research Hospital',
  tagline: 'World-Class Healthcare with Compassion & AI Care',
  phone: '+91 11 4988 2000',
  emergency_phone: '+91 11 4988 2911',
  whatsapp_number: '+91 98110 54321',
  email: 'care@apexhospital.org',
  address: 'Plot 4, Sector 12, Dwarka, Near Metro Pillar 412',
  city: 'New Delhi',
  state: 'Delhi NCR',
  pincode: '110075',
  google_maps_url: 'https://maps.google.com/?q=Apex+Hospital+Dwarka',
  ...
  facilities: [
    ...
    'Level III Neonatal & Paediatric ICU',
    'Modern Modular Operation Theatres (6 OT)',
    '24x7 In-House NABL Accredited Pathology & Diagnostics',
    '128 Slice Dual Energy CT Scanner & 3.0 Tesla Silent MRI',
    '24x7 In-House Pharmacy with Home Delivery',
    'Advanced Physiotherapy & Neuro-Rehabilitation Center',
    'Free Valet Parking & Wheelchair Assistance'
  ],
  insurance_supported: [
    'Star Health', 'HDFC ERGO', 'ICICI Lombard', 'Care Health Insurance',
    'Max Bupa / Niva Bupa', 'Bajaj Allianz', 'CGHS', 'ECHS', 'Ayushman Bharat (PM-JAY)'
  ],
  faqs: [
    {
      question: 'OPD appointment kaise book karein?',
      answer: 'Aap seedhe is WhatsApp par doctor ka naam, department ya apni problem likh kar bhej sakte hain. AI assistant aapko available time slots dikha kar turant book kar dega.'
    },
    {
      question: 'Emergency me kya karein?',
      answer: 'Emergency ke liye turant hamare 24x7 helpline +91 11 4988 2911 par call karein ya gate number 1 ke Emergency ward me sidhe aayein. Ambulance service bhi available hai.'
    },
    {
      question: 'Reports online kaise milengi?',
      answer: 'Test hone ke 4 se 6 ghante baad aapki NABL report is WhatsApp number par PDF format me automatically bhej di jayegi.'
    },
    {
      question: 'Cashless Mediclaim available hai kya?',
      answer: 'Haan, hamare yahan sabhi major TPA aur Insurance companies (Star, HDFC, ICICI, Niva Bupa, CGHS, PM-JAY) ke cashless admissions ki suvidha uplabdh hai.'
    }
  ],
...
export const SEED_PATIENTS: Patient[] = [
  {
    ...
    dob: '1984-05-12',
    age: 42,
    address: 'B-142, Palam Extension, Sector 7 Dwarka, Delhi',
...
export const SEED_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    sender_name: 'Apex AI Front Desk',
    message_type: 'TEXT',
  ...
  },
  {
    ...
    hospital_id: 'hosp_apex_01',
    sender_type: 'AI_AGENT',
    sender_name: 'Apex AI Appointment Desk',
    message_type: 'TEXT',
...
export const SEED_CAMPAIGNS: Campaign[] = [
  {
    ...
    message_template: 'Namaste {{name}} ji! 🏥 Apex Hospital me is Somvar (31 Aug) ko Free Diabetes & Heart Checkup Camp aayojit kiya ja raha hai. Kya aap apna slot register karna chahenge?\n\n1️⃣ Haan, slot book karein\n2️⃣ Baad me',
